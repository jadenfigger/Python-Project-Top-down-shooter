        ...
        for direction in self.attackingSprites:
            for i in range(5):
                self.attackingSprites[direction].append(pygame.transform.scale(
                    self.attackingSpritePaths[count].subsurface((8 + i * 32, 6, 17, 22)), (48, 66)))  # TODO fix
                self.swordSprites[direction].append(pygame.transform.scale(
                    self.swordSpritePaths[count].subsurface((8 + i * 32, 6, 17, 22)), (48, 66)))  # TODO fix
            count += 1
